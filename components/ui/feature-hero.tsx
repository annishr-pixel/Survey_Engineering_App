...
export const FeatureHero = () => {
  return (
    <section className="py-24 bg-white px-6 font-sans relative min-h-screen">
      ...
      <div className="py-24 px-6 max-w-7xl mx-auto text-center font-sans relative">
        <motion.div
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-slate-900 mb-6 text-balance">
            Empower Your Business <br /> with AI-Driven Solar Solutions
          </h1>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto mb-20 text-pretty">
            Leverage cutting-edge AI tools to optimize solar installations, allocate
            resources efficiently, and unlock actionable insights—all in one platform.
          </p>
        </motion.div>
